...
import com.mydataway.demo1.system.dto.RoleMenuUpdateDto;
...
//    @PreAuthorize("@el.check('roles:edit')")
    public BusinessResponse updateMenu(@RequestBody RoleMenuUpdateDto roleMenuUpdateDto) {
        roleService.updateMenu(roleMenuUpdateDto);
        return new BusinessResponse(CommonResponseEnum.SUCCESS.getCode(), CommonResponseEnum.SUCCESS.getmsg());
    }
